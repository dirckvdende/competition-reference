...
\pgfmathsetseed{\number\pdfrandomseed}
\pgfmathsetmacro{\RandomID}{random(100000000,999999999)}

\setlength{\headheight}{15pt}
\pagestyle{fancyplain}
\lhead{\universityname\ --\ \doctitle}
\chead{}
\rhead{DocID: \RandomID \qquad \qquad Page \thepage/\pageref{LastPage}}
\lfoot{}
\cfoot{}
\rfoot{}
...
\begin{center}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[height=100pt]{\logofile}
    \label{fig:logo}
\end{figure}
\end{center}
